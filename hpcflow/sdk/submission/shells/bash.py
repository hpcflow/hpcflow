...
class WSLBash(Bash):
    ...
    JS_RUN_CMD: ClassVar[str] = (
        ...
        WSLENV=$WSLENV:${{APP_CAPS}}_SUB_SCRIPTS_DIR/p
        WSLENV=$WSLENV:${{APP_CAPS}}_SUB_TMP_DIR/p
        WSLENV=$WSLENV:${{APP_CAPS}}_SUB_LOG_DIR/p
        WSLENV=$WSLENV:${{APP_CAPS}}_SUB_STD_DIR/p
